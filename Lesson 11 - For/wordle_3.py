...
while game_play == True:
    ...
    while guess <= 6:
        ...
        if user_guess == wordle_word:
            for i in range(5):
                correct = f"\033[32m{user_guess[i]}\033[0m"
                guess_check.append(correct)
            print()
        ...
        # Create a for loop that loops 5 times
            ...
            for i in range(5):
                ...
                # Otherwise check if the current letter of user_input is in the word and if it is, tell them that letter is in the wrong position
                    ...
                    maybe = f"\033[38;2;255;165;0m{user_guess[i]}\033[0m"
                    guess_check.append(maybe)

                # Else tell them that letter is wrong
                else:
                    wrong = f"\033[31m{user_guess[i]}\033[0m"
                    guess_check.append(wrong)
