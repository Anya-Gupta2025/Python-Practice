...
while game_play == True:
    ...
    while guess <= 6:
        ...
        if user_guess == wordle_word:
            print(f"\nThat's correct! You are a mastermind! You got the world in {guess} guesses!")
            break
        ...
        # Create a for loop that loops 5 times
            ...
            for i in range(5):
                ...
                if user_guess[i] == wordle_word[1]:
                    print(f"\nYou got letter {i+1} correct! So the {user_guess[i]} in {user_guess} is correct!")
                ...
                # Else tell them that letter is wrong
                    ...
                    print(f"\nThe letter {user_guess[i]} in your guess: {user_guess}, is wrong and isn't in the secret word.")
