...
while game_play == True:
    ...
    while guessed_number != secret_number:
        ...
        if guessed_number < secret_number and secret_number - guessed_number <= 5:
            print("\nThat is very close but you guess is a bit too low! The secret number is 5 or less numbers away!\n")
        
        if guessed_number > secret_number and guessed_number - secret_number <= 5:
    ...
    response = input("\nWould you like to play again (new number this time!)? Enter yes/y or no/n: ").strip().lower()
